...
namespace Akalaat.DAL.Data.Migrations
{
    ...
    [Migration("20240316121429_Add_ShoppingCart_Model")]
    partial class Add_ShoppingCart_Model
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ItemShoppingCart", b =>
                {
                    ...
                    b.HasKey("ItemsId", "ShoppingCartsId");
            ...
            modelBuilder.Entity("ItemShoppingCart", b =>
                {
                    ...
                    b.HasOne("Akalaat.DAL.Models.ShoppingCart", null)
                        .WithMany()
